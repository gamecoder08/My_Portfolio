    ...
    return (
        ...
        >
            <div className='h-full w-full flex flex-col gap-5 justify-center m-auto text-start'>
                ...
                <h1 className='Welcome-text text-[13px]'>Software Developer Engineer Portfolio</h1>
                ...
                >
                    I am a passionate adaptive software developer dedicated to crafting innovative and efficient solutions. Explore my portfolio to see how I can bring value to your projects.
                </motion.p>
                <motion.a
