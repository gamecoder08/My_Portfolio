    ...
    return (
        <div className="w-full fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-90 px-4 sm:px-5 py-2">
            <div className="relative flex items-center justify-center w-full h-full">
                ...
                <div className="flex items-center justify-center border md:min-w-150 border-[#7042f861] bg-[#0300145e] px-2 sm:px-5 py-2.5 rounded-full text-gray-200 gap-2 sm:gap-4">
