...
const AboutMe = () => {
    return (
        ...
        >
            ...
            <motion.div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-70 px-6 py-10" initial="hidden" animate="visible">
                ...
                <motion.div
                    className="flex flex-col text-justify text-white gap-5 max-w-[700px]"
